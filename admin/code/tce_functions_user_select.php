...
echo '<td>&nbsp;'.htmlspecialchars($m['user_regdate'] ?? '', ENT_NOQUOTES, $l['a_meta_charset']).'</td>'.K_NEWLINE;
            ...
            echo '<input type="radio" name="checkall" id="checkall1" value="1" onclick="checkAll(\'#form_userselect td input[type=checkbox]\')" />';
            echo '<label for="checkall1">'.$l['w_check_all'].'</label> ';
            echo '<input type="radio" name="checkall" id="checkall0" value="0" onclick="unCheckAll(\'#form_userselect td input[type=checkbox]\')" />';
