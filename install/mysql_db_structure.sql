...
CREATE TABLE tce_sessions (
	...
	cpsession_user_id Bigint UNSIGNED NOT NULL,
 Primary Key (cpsession_id)
) ENGINE = InnoDB
CHARACTER SET utf8 COLLATE utf8_unicode_ci;


CREATE TABLE tce_chat_msg (
  ...
  to_group_id bigint(20) UNSIGNED DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;


CREATE TABLE tce_chat_log (
...
CREATE TABLE tce_answers (
	...
	answer_weight Smallint(10) UNSIGNED NULL,
...
ALTER TABLE tce_chat_msg MODIFY msg_id INT AUTO_INCREMENT PRIMARY KEY;

ALTER TABLE tce_sessions MODIFY cpsession_user_id BIGINT UNSIGNED NOT NULL DEFAULT 0;
COMMIT;