...
echo '>Tecnick.com LTD</a> - <a href="https://github.com/SecretDiscorder" target="blank" class="tmfpatch">tmfpatch v'.file_get_contents('../../TMFPATCHVERSION').'</a> by <a href="py.bima-pustaka.my.id" target="blank" class="tmfpatch">SecretDiscorder</a> - this site is authored by <a class="tmfpatch" href="mailto:'.K_SITE_REPLY.'">'.K_SITE_AUTHOR.'</a></span>';
