 ...
 * @return substring
 */
function F_substr_utf8($str, $length, $start = 0)
{
...
function F_formatFloatAlt($num)
{
    return str_replace('.',',',sprintf('%.02f', round($num, 2)));
}
...
function F_formatPercentageAlt($num, $ratio = true)
{
    if ($ratio) {
        $num = (100 * $num);
    }
