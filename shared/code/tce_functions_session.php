...
/**
 */
// Pindahkan ini ke atas sebelum session_start()
ini_set('session.cookie_domain', '.bima-pustaka.my.id');
ini_set('session.cookie_secure', 1);  // Pastikan HTTPS digunakan untuk cookie
