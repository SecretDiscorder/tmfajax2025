...
{
    echo '<input type="submit" class="'.$class.' text-capitalize" name="'.$name.'" id="'.$name.'" value="'.$value.'" title="'.$title.'" />';
}
...
function getFormRowTextInput($field_name, $name, $description = '', $tip = '', $value = '', $format = '', $maxlen = 255, $date = false, $datetime = false, $password = false, $prefix = '', $group = false)
{
    ...
    $str .= ' name="'.$field_name.'" id="'.$field_name.'" value="'.htmlspecialchars($value, ENT_COMPAT, $l['a_meta_charset']).'" size="20" maxlength="'.$maxlen.'" title="'.$description.'" class="form-control" />';
    $str .= $button;
...
function getFormRowTextBox($field_name, $name, $description = '', $value = '', $disabled = false, $prefix = '')
{
    ...
    $str .= '<textarea class="form-control" cols="50" rows="5" name="'.$field_name.'" id="'.$field_name.'" title="'.$description.'"';
    if ($disabled) {
...
function getFormRowCheckBox($field_name, $name, $description = '', $tip = '', $value = '', $selected = false, $disabled = false, $prefix = '')
{
	...
	$str .= '<label class="custom-control-label" for="'.$field_name.'" title="'.$description.'">'.$name.'</label>'.K_NEWLINE;
    $str .= '</div>'.K_NEWLINE;
    $str .= '</div>'.K_NEWLINE;
    return $str;
}
