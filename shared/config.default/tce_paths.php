 ...
 */
define('K_PATH_HOST', 'https://cbt.bima-pustaka.my.id');
/* if((!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') || $_SERVER['SERVER_PORT'] == 443)
{
	define('K_PATH_HOST', 'https://cbt.bima-pustaka.my.id'.$_SERVER['SERVER_NAME']);
}else{
	define('K_PATH_HOST', 'https://cbt.bima-pustaka.my.id'.$_SERVER['SERVER_NAME']);
} */
/**
 ...
 */
define('K_PATH_TCEXAM', '/tmfajax/');

/**
 * Real full path where this program is installed (e.g: "/var/www/html/TCExam/").
 */
define('K_PATH_MAIN', '/home/bimapust/domains/cbt.bima-pustaka.my.id/public_html/tmfajax/');
